...
export type ClueResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Clue"] = ResolversParentTypes["Clue"]
> = {
...
export type HuntResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Hunt"] = ResolversParentTypes["Hunt"]
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  clues?: Resolver<
    Maybe<Array<ResolversTypes["Clue"]>>,
    ParentType,
    ContextType
  >;
...
> = {
  ...
  createMultipleClues?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Clue"]>>>,
    ParentType,
    ContextType,
  ...
  login?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationLoginArgs, "password" | "user_name">
  >;
};
...
> = {
  ...
  getSingleUser?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetSingleUserArgs, "uid">
  >;
...
export type ResponsePayloadResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ResponsePayload"] = ResolversParentTypes["ResponsePayload"]
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
