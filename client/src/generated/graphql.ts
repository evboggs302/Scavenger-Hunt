...
export type UserFragment = { __typename: 'UserPayload', _id: string, user_name: string, first_name: string, last_name: string, account: string };
...
export type GetUserFromTokenQuery = { user: { __typename: 'UserPayload', _id: string, user_name: string, first_name: string, last_name: string, account: string } };
