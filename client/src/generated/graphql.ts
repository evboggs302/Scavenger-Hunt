...
export type GetUserFromTokenQuery = { getUserFromToken?: { __typename: 'UserPayload', _id: string, user_name: string, first_name: string, last_name: string } | null };
