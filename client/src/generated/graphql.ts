...
export type CreateHuntMutation = { hunt?: { __typename: 'Hunt', _id: string, created_by: string, name?: string | null, created_date?: string | null, start_date?: string | null, end_date?: string | null, is_active?: boolean | null, recall_message?: string | null } | null };
...
export type GetOrderedCluesQuery = { clues?: Array<{ __typename: 'CluePayload', _id: string, hunt_id: string, order_number?: number | null, description?: string | null } | null> | null };
...
export type GetUserFromTokenQuery = { user?: { __typename: 'BaseUserPayload', _id: string, user_name: string, first_name: string, last_name: string } | null };
