...
export type CreateHuntMutation = {
  hunt?: {
    __typename: "Hunt";
    _id: string;
    created_by: string;
...
export type LoginUserMutation = {
  login: { __typename: "AuthPayload"; _id: string; token: string };
};
...
export type RegisterUserMutation = {
  registerUser: { __typename: "AuthPayload"; _id: string; token: string };
};
...
export type GetHuntsByUserIdQuery = {
  hunts?: Array<{
    __typename: "Hunt";
    _id: string;
    created_by: string;
...
export type GetOrderedCluesQuery = {
  clues?: Array<{
    __typename: "CluePayload";
    _id: string;
    hunt_id: string;
...
export type GetResponsesByHuntQuery = {
  hunt?: {
    __typename: "Hunt";
    teams?: Array<{
      __typename: "Team";
      responses?: Array<{
        ...
        response_txt?: string | null;
        response_img?: Array<string | null> | null;
        correct?: boolean | null;
        hint_sent?: boolean | null;
      }> | null;
    }> | null;
  } | null;
};
  ...
  definitions: [
    {
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "CluePayload" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "_id" } },
          { kind: "Field", name: { kind: "Name", value: "hunt_id" } },
          { kind: "Field", name: { kind: "Name", value: "order_number" } },
          { kind: "Field", name: { kind: "Name", value: "description" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<ClueFragment, unknown>;
export const HuntFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "Hunt" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "Hunt" },
      },
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "recall_message" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<HuntFragment, unknown>;
export const FullHuntFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FullHunt" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "Hunt" },
      },
          ...
          { kind: "Field", name: { kind: "Name", value: "created_by" } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "_id" } },
                { kind: "Field", name: { kind: "Name", value: "hunt_id" } },
                { kind: "Field", name: { kind: "Name", value: "recall_sent" } },
                {
                  kind: "Field",
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "device_number" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<FullHuntFragment, unknown>;
  ...
  definitions: [
    {
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "BaseUserPayload" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
  ...
  definitions: [
    {
      ...
      operation: "mutation",
      name: { kind: "Name", value: "CreateHunt" },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "recall_message" },
          },
...
} as unknown as DocumentNode<CreateHuntMutation, CreateHuntMutationVariables>;
...
} as unknown as DocumentNode<GetHuntQuery, GetHuntQueryVariables>;
export const GetHuntsByUserIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetHuntsByUserId" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "hunts" },
            name: { kind: "Name", value: "getHuntsByUserId" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
  ...
  GetHuntsByUserIdQuery,
  GetHuntsByUserIdQueryVariables
>;
export const GetOrderedCluesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetOrderedClues" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "clues" },
            name: { kind: "Name", value: "getCluesByHuntId" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
...
>;
export const GetResponsesByHuntDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetResponsesByHunt" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "response_txt" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "response_img" },
                            },
                            {
                              kind: "Field",
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "hint_sent" },
                            },
                          ],
                        },
                      },
  ...
  GetResponsesByHuntQuery,
  GetResponsesByHuntQueryVariables
>;
export const GetUserFromTokenDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUserFromToken" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "tkn" } },
          type: {
            kind: "NonNullType",
            type: {
              kind: "NamedType",
...
} as unknown as DocumentNode<UsernameExistsQuery, UsernameExistsQueryVariables>;
