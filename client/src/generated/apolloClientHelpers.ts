...
export type AuthPayloadKeySpecifier = (
  | "_id"
  | "token"
...
export type BaseUserPayloadKeySpecifier = (
  | "_id"
  | "first_name"
  | "last_name"
  | "user_name"
  | BaseUserPayloadKeySpecifier
)[];
...
export type CluePayloadKeySpecifier = (
  | "_id"
  | "description"
  | "hunt_id"
  | "order_number"
  | "responses"
  | CluePayloadKeySpecifier
)[];
...
export type ResponsePayloadKeySpecifier = (
  | "_id"
  | "clue_id"
  | "correct"
  | "hint_sent"
...
export type UserPayloadKeySpecifier = (
  | "_id"
  | "first_name"
  | "hunts"
  | "last_name"
  | "user_name"
  | UserPayloadKeySpecifier
)[];
...
export type StrictTypedTypePolicies = {
  ...
  BaseUserPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | BaseUserPayloadKeySpecifier
      | (() => undefined | BaseUserPayloadKeySpecifier);
  ...
  CluePayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | CluePayloadKeySpecifier
      | (() => undefined | CluePayloadKeySpecifier);
  ...
  ResponsePayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | ResponsePayloadKeySpecifier
      | (() => undefined | ResponsePayloadKeySpecifier);
  ...
  UserPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | UserPayloadKeySpecifier
      | (() => undefined | UserPayloadKeySpecifier);
